...
1. **Unnepnapok.com** - Comprehensive Hungarian holiday list with munkaszüneti napok and szombati munkanapok
2. **PontosIdo.com** - Excellent Hungarian source for munkaszüneti napok with well-structured data
3. **SzakmaiKamara.hu** - Hungarian professional chamber website with hosszú hétvégék info
4. **MFA.gov.hu** - Official Hungarian Ministry of Foreign Affairs ([source](https://almati.mfa.gov.hu/hu/hu-uennepnapok))
5. **DailyNewsHungary.com** - English-language Hungarian news with workday announcements

### International Sources (Fallback)

6. **TimeAndDate.com** - Wide year coverage
7. **OfficeHolidays.com** - Backup source
  ...
  "weekend_workdays": [
    {
      ...
      "reason": "Bridge day for Labour Day",
      "related_holiday": null
    },
    {
      "date": "2025-10-18",
      "original_day": "Saturday",
      "reason": "Bridge day for October 23",
      "related_holiday": null
    },
    {
      "date": "2025-12-13",
      "original_day": "Saturday",
      "reason": "Bridge day for Christmas Eve",
      "related_holiday": null
    }
  ],
  "source": {
